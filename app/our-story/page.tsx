  ...
  return (
    <div className="mx-auto max-w-2xl px-5 py-14">
      ...
      <div className="mt-8 space-y-5 leading-relaxed text-cocoa/80">
        <p>
          Aunty Hong fries belinjau keropok and packs CNY boxes from a kitchen at Aljunied, not from a
          warehouse floor. The shop you are looking at is a design demo of that house — the live store
          remains at auntyhong.sg.
        </p>
        <p>
